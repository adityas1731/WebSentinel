...
problematic_files = []  # List to track problematic files
problematic_characters = []  # List to track problematic characters
...
for file in files:
    ...
    try:
        ...
        problematic_characters.append(str(e))

output.close()

if problematic_files:
    print("\nProblematic files:")
    for file, error in zip(problematic_files, problematic_characters):
